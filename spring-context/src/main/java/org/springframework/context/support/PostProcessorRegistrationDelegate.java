...
final class PostProcessorRegistrationDelegate {
	 ...
	 * 其中ConfigurationClassPostProcessor就是一个spring内部的 BeanDefinitionRegistryPostProcessor
	 * 	因为如果你不添加这里就没有办法委托 ConfigurationClassPostProcessor 做一些功能
	 *
	 * @param beanFactory
	...
	public static void invokeBeanFactoryPostProcessors(
		...
		if (beanFactory instanceof BeanDefinitionRegistry) {
			...
			/**
			 * 保存自定义实现了BeanFactoryPostProcessor接口的类
			 */
			List<BeanFactoryPostProcessor> regularPostProcessors = new ArrayList<>();
			/**
			 * 保存自定义实现了 BeanDefinitionRegistryPostProcessor 接口的类
			 */
			...
			/**
			 * currentRegistryProcessors 保存的是 spring 内部的实现了BeanDefinitionRegistryPostProcessor接口
			 */
			 ...
			 *
			 * getBeanNamesForType，通过类型得到bean的name
			 *
			 * 得到：
	...
	public static void registerBeanPostProcessors(
		 ...
		 * 可能会有些情况，当 spring 的配置中的后置处理器还没有被注册就
		 * 已经开始了 bean 的初始化，这时便会打印出 BeanPostProcessorChecker 中设定的信息
		 */
		 ...
		 * 并非重复注册，在 beanFactory.addBeanPostProcessor 中会先移除已经存在的
		 *
		 */
